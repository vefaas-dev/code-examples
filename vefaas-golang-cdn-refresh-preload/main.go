...
import (
	...
	"vefaas-golang-cdn-refresh-preload-trigger/handlers"
...
func init() {
	cdn.DefaultInstance.Client.SetAccessKey(os.Getenv("CloudAPI_AccessKey"))
	cdn.DefaultInstance.Client.SetSecretKey(os.Getenv("CloudAPI_SecretKey"))
}
