# Native Python 3.12 Function Template

This repository provides a Native Python 3.12 template that can be directly deployed to veFaaS. Recommended workflow:
