# Native Python 3.10 Function Template

This repository provides a Native Python 3.10 template that can be directly deployed to veFaaS. Recommended workflow:
...
- Click "Install Dependencies" in the console. The platform will install the dependencies in the Linux Python 3.10 environment to the runtime directory
