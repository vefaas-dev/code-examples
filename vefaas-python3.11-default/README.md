...
- If `requirements.txt` contains dependencies, click "Install Dependencies" in the console. The platform will install the dependencies in the Linux Python 3.11 environment to the runtime directory
